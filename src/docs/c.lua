...
-- <errno.h>
EDOM = 'http://linux.die.net/man/3/errno',
EILSEQ = 'http://linux.die.net/man/3/errno',
ERANGE = 'http://linux.die.net/man/3/errno',
errno = 'http://linux.die.net/man/3/errno',

-- <locale.h>
LC_ALL = 'http://linux.die.net/man/3/setlocale',
LC_COLLATE = 'http://linux.die.net/man/3/setlocale',
LC_CTYPE = 'http://linux.die.net/man/3/setlocale',
LC_MONETARY = 'http://linux.die.net/man/3/setlocale',
LC_NUMERIC = 'http://linux.die.net/man/3/setlocale',
LC_TIME = 'http://linux.die.net/man/3/setlocale',
lconv = 'http://linux.die.net/man/3/localeconv',
...
-- <signal.h>
SIGABRT = 'http://linux.die.net/man/7/signal',
SIGFPE = 'http://linux.die.net/man/7/signal',
SIGILL = 'http://linux.die.net/man/7/signal',
SIGINT = 'http://linux.die.net/man/7/signal',
SIGSEGV = 'http://linux.die.net/man/7/signal',
SIGTERM = 'http://linux.die.net/man/7/signal',
SIG_DFL = 'http://linux.die.net/man/7/signal',
SIG_ERR = 'http://linux.die.net/man/7/signal',
SIG_IGN = 'http://linux.die.net/man/7/signal',
raise = 'http://linux.die.net/man/3/raise',
signal = 'http://linux.die.net/man/2/signal',

-- <stdarg.h>
va_start = 'http://linux.die.net/man/3/va_arg',
va_arg = 'http://linux.die.net/man/3/va_arg',
va_end = 'http://linux.die.net/man/3/va_arg',
va_list = 'http://linux.die.net/man/3/va_arg',
